...
<body background=http://image2.sina.com.cn/home/images/tz-001.gif>
	<script type="text/javascript">
		...
		function toHome() {
			if (!isIFrameSelf()) {
				window.location.href = "http://localhost:8080/gz_ssm/pages/users/login.jsp";
			}
		}
	...
	<table width=544 height=157 border=0 cellpadding=0 cellspacing=0
		...
		<tr valign=middle align=middle>
			<td background=http://image2.sina.com.cn/home/images/tz-002.gif>
				<table border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td style="padding-left: 80px; padding-top: 10px"><strong>邮箱激活成功！
								5秒钟之后将会带您进登录页面!</strong></td>
					</tr>
				</table>
			</td>
		</tr>
